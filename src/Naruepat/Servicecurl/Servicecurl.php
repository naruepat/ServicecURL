...
class Servicecurl {
  ...
  //    */
	protected $config;
 	...
 	// {
 	// 	return $this->config->get('servicecurl::domain');
	 ...
	 * @var string
	 */
	protected $requestClass = 'Naruepat\Servicecurl\Request';
	 ...
	 * @var string
	 */
	protected $responseClass = 'Naruepat\Servicecurl\Response';
	...
	{
		return $this->config->get('servicecurl::client_id');
	}

	public function getClientSecret()
	{
		return $this->config->get('servicecurl::client_secret');
	}
